...
matched = image.load('other_assests/matched.png')

current_images=[]
running = True
tiles=[animal(i) for i in range(0,gc.total_tiles)]
while running:
    ...
    for e in current_events:
        ...
        if e.type==pygame.MOUSEBUTTONDOWN:
            ...
            index=get_index(mouse_x,mouse_y)
